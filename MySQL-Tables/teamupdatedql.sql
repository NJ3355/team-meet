...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2015 at 03:11 AM
...
(9, 'uploads/TM-logo.jpg', 18, 'njohn', '2015-11-30 18:26:31');
...
(22, 'heyyyyy', 'sjohn1', 1, '2015-11-13 19:19:28'),
(23, 'heyyyyy', 'sjohn1', 2, '2015-11-13 19:19:39'),
(24, 'test', 'njohn', 1, '2015-11-15 21:44:47'),
(25, 'test2', 'njohn', 1, '2015-11-15 21:45:19'),
(26, 'hey', 'njohn', 1, '2015-11-17 22:49:49'),
(27, 'hey', 'njohn', 5, '2015-11-18 21:05:48'),
(28, 'hey', 'njohn', 1, '2015-11-24 16:40:42'),
(29, 'hey', 'njohn', 1, '2015-11-24 16:40:51'),
(30, 'yo', 'njohn', 1, '2015-11-24 16:40:55'),
(31, 'hey', 'njohn', 18, '2015-11-30 18:25:58'),
(32, 'whatsup', 'njohn', 18, '2015-11-30 18:26:03'),
(33, 'hey sam', 'njohn', 20, '2015-11-30 18:56:54'),
(34, 'heyy', 'njohn', 23, '2015-11-30 20:45:06');
...
(58, 'njohn', '2015-11-29 20:04:29', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `private_messaging` (
  ...
  KEY `sentUserName` (`sentUserName`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `private_messaging`
--

INSERT INTO `private_messaging` (`privateMessageID`, `message`, `sentUserName`, `recievingUsername`, `date`) VALUES
(1, 'test', 'njohn', 'njohn', '2015-11-18 21:35:23'),
(2, 'Hey sam whatsup?', 'njohn', 'sjohn1', '2015-11-18 21:49:34'),
(3, 'hey whatsup', 'njohn', 'njohn', '2015-11-27 19:05:42'),
(4, 'can you see this?', 'sjohn1', 'njohn', '2015-11-30 20:43:03');
...
(5, 'nick', 'johnson', '2015-11-18 20:13:07', 0),
(13, 'asd', 'asd', '2015-11-30 18:09:47', 0),
(14, 'asd', 'asd', '2015-11-30 18:10:12', 0),
(15, 'asd', 'asd', '2015-11-30 18:16:36', 0),
(17, 'PRoject 1 ', 'test', '2015-11-30 18:24:43', 0),
(18, 'PRoject 1 ', 'test', '2015-11-30 18:25:48', 0),
(19, 'hello2q', 'heyy', '2015-11-30 18:38:22', 0),
(20, 'The Project', 'This is the description ', '2015-11-30 18:56:21', 0),
(22, 'sdfsd', 'sdfs', '2015-11-30 18:57:33', 0),
(23, 'Sams project', 'This is sams project', '2015-11-30 20:43:55', 0);
...
INSERT INTO `users_assigned` (`permissionID`, `permission`, `projectID`, `username`, `projectsID`, `projectname`, `projectdescription`) VALUES
(5, '', NULL, 'njohn', 18, 'PRoject 1 ', 'test'),
(11, '', NULL, '', 18, '', ''),
(12, '', NULL, 'sjohn1', 18, '', ''),
(13, '', NULL, 'sjohn1', 20, 'new project', 'new'),
(14, '', NULL, 'njohn', 20, 'new project', 'new'),
(16, '', NULL, 'njohn', 22, 'sdfsd', 'sdfs'),
(17, '', NULL, 'sjohn1', 23, 'Sams project', 'This is sams project'),
(18, '', NULL, 'njohn', 23, 'Sams project', 'This is sams project');
...
(1, 'Nicholas', 'Johnson', 'njohn@farmingdale.edu', 'njohn', '32aa0c466818e1ccba25b8793db98c94', NULL, NULL),
...
ALTER TABLE `private_messaging`
  ADD CONSTRAINT `private_messaging_ibfk_1` FOREIGN KEY (`sentUserName`) REFERENCES `user_profile` (`username`);
