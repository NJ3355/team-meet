...
echo "Errors occurred: $status";
 ...
 $forename = $surname = $username = $password = $pass2 = $email = "";
  ...
  add_userlogin($connection, $username, $token);
...
echo "<a href='checkuserform.html'>Click here to log-in</a>";
  ...
  {
    $query  = "INSERT INTO user_profile (forename, surname, email, username, password)VALUES('$fn', '$sn', '$email', '$un', '$pw')";
    ...
    function add_userlogin($connection, $un, $pw)
  {
    $query  = "INSERT INTO user_login (username, password)VALUES('$un', '$pw')";
